  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 p-8">
      ...
      <section className="space-y-3">
        ...
        <ul className="space-y-1 rounded-2xl border border-neutral-200 p-4 text-sm dark:border-neutral-800">
          {variantList.map((v) => (
        ...
        <form action={addVariant} className="grid gap-3 rounded-2xl border border-neutral-200 p-4 sm:grid-cols-3 dark:border-neutral-800">
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {noteTypes.map(([type, label]) => (
            <div key={type} className="rounded-2xl border border-neutral-200 p-4 dark:border-neutral-800">
      ...
      <section className="space-y-3">
        ...
        <form action={addBatch} className="grid gap-3 rounded-2xl border border-neutral-200 p-4 sm:grid-cols-2 dark:border-neutral-800">
          <input type="hidden" name="product_id" value={id} />
